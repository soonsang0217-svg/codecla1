...
> 텍스트로 대조해서 판단합니다. "충청남도(보령도서 제외)"처럼 제외/포함 목록이 있는
> 경우는 해석해서 정확도를 높였지만, "인천남부"·"부산동부"처럼 기상청이 방위 기준으로
> 지역을 묶어 표기하는 경우는 사용자의 구체적인 동/구 이름과 문자 그대로 일치하지
> 않아 놓칠 수 있습니다. 정식 특보구역 코드 기반 조회는 아닙니다.
